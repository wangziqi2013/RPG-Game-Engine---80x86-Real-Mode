...
void VGA::Change(unsigned char mode)
{
 asm push ax
...
void VGA::DrawLine(unsigned char color,int x,int y,int w,int h)
{
 float inc_w = 0;
 float inc_h = 0;
 float xx = x;
...
void VGA::DrawPixel(unsigned char color,int x,int y)
{
 asm push bx
 asm push es
 asm push ax
...
/*************************************************************/
void VGA::DrawBlock(void far *buffer,int x,int y,int w,int h)
{
 asm push bx
 asm push es
 asm push ds
...
/* Notice that w and h must be grater than 0 (not equal)       */
/***************************************************************/
void VGA::RetrieveBlock(void far *buffer,int x,int y,int w,int h)
{
 asm push bx
 asm push es
 asm push ds
